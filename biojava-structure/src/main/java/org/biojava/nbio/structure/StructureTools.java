...
public class StructureTools {
     ...
     *
     * @param groupCode3 3-character code for a group.
     */
     ...
     *
     * @param chain
     * @param atomNames the array with atom names to be used. Beware: CA will do both
    ...
    public static AtomContactSet getAtomsInContact(Chain chain, double cutoff) {
        return getAtomsInContact(chain, null, cutoff);
    }
     ...
     * @param useAverageDistance When set to true, distances are the arithmetic mean (1-norm)
     ...
     * Groups returned
     *
     * @param structure    The structure to work with
     * @param group        The 'query' group
     * @param distance     The cutoff distance
     * @param includeWater Should water residues be included in the output?
     ...
     * @param parser A clean PDBFileParser to use if it is a file. If null, a
     ...
     * @throws StructureException if the format is unknown, or if AtomCache throws an
     *                            exception.
     */
