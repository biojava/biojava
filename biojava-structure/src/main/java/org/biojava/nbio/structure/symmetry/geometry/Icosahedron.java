...
public class Icosahedron implements Polyhedron {
	private static final int[] lineLoop1 = {4,0,1,2,3,4,5,1};
	private static final int[] lineLoop2 = {3,0,2};
	private static final int[] lineLoop3 = {0,5};
	private static final int[] lineLoop4 = {11,3,7,4,8,6,7,8,9,10,11,7};
	private static final int[] lineLoop5 = {6,11,2,10,1,9,6,10};
	private static final int[] lineLoop6 = {8,5,9};
