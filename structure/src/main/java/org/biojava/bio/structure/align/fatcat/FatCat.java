...
//         }
   ...
   public String printHelp(){
      ...
      buf.append("-------------------" + newline);
      buf.append(newline);
      buf.append("JFatCat accepts the following parameters:" + newline);
      buf.append(newline);
      ...
      buf.append("-flexible true/false run flexible alignment (default: rigid body alignment, false). " + newline);
