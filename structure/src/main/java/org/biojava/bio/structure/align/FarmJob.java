...
public class FarmJob implements Runnable {
	...
	public void printHelp(){
		...
		System.out.println(" Mandatory:: provided either -time or -nrAlignments. If both are provided the job stops as soon as any of the criteria has been reached.");
		...
		System.out.println(" -server the location of the server URL to talk to. Default : " + FarmJobParameters.SERVER_URL);
