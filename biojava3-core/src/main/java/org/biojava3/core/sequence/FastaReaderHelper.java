...
public class FastaReaderHelper {
    ...
    public static List<ProteinSequence> readFastaProteinSequence(File file) throws Exception {
    ...
    /**
     * Read a fasta file containing amino acids with setup that would handle most cases.
     * User is responsible for closing InputStream because you opened it
     * @param inStream
     * @return
     * @throws Exception
     */

    public static List<ProteinSequence> readFastaProteinSequence(InputStream inStream) throws Exception {
