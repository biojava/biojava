...
public final class SequenceUtil {
    ...
    public static boolean isNonAmbNucleotideSequence(String sequence) {
        ...
        return SequenceUtil.NUCLEOTIDE.matcher(sequence).find();
    }
    ...
    public static String cleanSequence(String sequence) {
        ...
        return SequenceUtil.WHITE_SPACE.matcher(sequence).replaceAll("").toUpperCase();
    }
     ...
     * @param outstream
     * @param sequences
     * @param width     - the maximum number of characters to write in one line
     * @throws IOException
     */
