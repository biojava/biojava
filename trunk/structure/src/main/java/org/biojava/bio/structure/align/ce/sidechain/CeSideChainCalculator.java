...
public class CeSideChainCalculator  {
   ...
   public void extractFragments(CeParameters params, AFPChain afpChain,
      ...
      System.out.println("done init intra matrix");
                                 ...
                                 itLoop:
                                    for(int it=0; it<iterDepth; it++) {
                                       ...
                                       if(nTrace>nBestExtTrace || (nTrace==nBestExtTrace &&
                                             score2<bestExtScore)) {
                                          //System.out.println("setting traceindex to " + it + " " + score2 + " " + score1);
                                          bestExtScore=score2;
...
nBestTrace=nTrace;
   ...
   private double getScoreFromDistanceMatrices(int mse1, int mse2,int winSize) {
      ...
      for(int itrace=0; itrace<nTrace; itrace++) {
         ...
         //System.out.println("score step 3:" + score);
      }
      //System.out.println("getScoreFromDistanceMatrices " + nTrace + " " + mse1 + " " + mse2 + " " + winSize + " " + score);
      return score;
   }
   ...
   private void checkBestTraces(CeParameters params, AFPChain afpChain,
      ...
      if(params.isShowAFPRanges()) {
         ...
         System.out.println("NOT SHOWING AFP ranges...");
      }
   ...
   private int optimizeSuperposition(AFPChain afpChain, int nse1, int nse2, int strLen, double rmsd, Atom[] ca1, Atom[] ca2,int nGaps, 
      ...
      while(nAtom<strLen*0.95 || 
         ...
         if (debug) 
            System.out.println("iter: "+ counter + "  score:"  + score + " " + " nAtomPrev: " + nAtomPrev + " nAtom:" + nAtom + " oRmsdThr: " + oRmsdThr + " lcmp:" + lcmp);
