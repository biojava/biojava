...
public class SubstitutionMatrixHelper implements Serializable {
	...
	private static final Map<String, SubstitutionMatrix<AminoAcidCompound>> aminoAcidMatrices =
			new HashMap<>();
	private static final Map<String, SubstitutionMatrix<NucleotideCompound>> nucleotideMatrices =
			new HashMap<>();
