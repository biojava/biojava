...
public abstract class AbstractSequence<C extends Compound> implements Sequence<C> {
    ...
    private List<PublicationReference> publicationReference = new ArrayList<PublicationReference>();
    ...
    public List<PublicationReference> getPublicationReference() {
        return publicationReference;
    }

    public void setPublicationReference(List<PublicationReference> publicationReference) {
