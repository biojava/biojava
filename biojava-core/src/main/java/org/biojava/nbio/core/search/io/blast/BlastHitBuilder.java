...
public class BlastHitBuilder<S extends Sequence<C>,C extends Compound> {
	...
	public BlastHitBuilder<S, C> setHitSequence(S s) {
		this.hitSequence = s;
		return this;
	}

	public BlastHitBuilder<S, C> setHsps(List<Hsp<S,C>> hsps) {
		this.hsps = hsps;
		return this;
	}

	public BlastHit<S,C> createBlastHit() {
