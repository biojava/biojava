...
public class GenbankSequenceParser<S extends AbstractSequence<C>, C extends Compound> implements SequenceParserInterface {
    ...
    private List<PublicationReference> references = new ArrayList<PublicationReference>();
    ...
    protected static final Pattern authorsPattern = Pattern.compile("(\\w+?,(\\w{1}.)*)");
...
//  private NCBITaxon tax = null;
        ...
        do {
            ...
            if (sectionKey.equals(LOCUS_TAG)) {
                ...
                if (section.size() == 5) {
                    ...
                    String pubmedId = section.get(4)[1];
                    reference.setId(pubmedId);
                } else if (journal.startsWith("Patent")) {
    ...
    public List<PublicationReference> getPublicationReferences() {
