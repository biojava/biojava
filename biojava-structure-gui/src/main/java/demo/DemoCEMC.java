...
public class DemoCEMC {
	...
	public static void main(String[] args) throws IOException, StructureException, StructureAlignmentException, InterruptedException, ExecutionException {
		...
		//List<String> names = Arrays.asList("1tim.A", "1vzw", "1nsj", "3tha.A");
		//Helix-bundle (MUSTA paper)
		List<String> names = Arrays.asList("1flx", "1bbh.A", "1aep", "1bge.B", "1ile2", "256b.A", "2ccy.A", "2hmz.A", "3ink.C");
		//GPCRs
		...
		//List<String> names = Arrays.asList("d1heta2", "d1ek6a", "d1obfo1", "d2cmd_1", "d1np3a2", "d1bgva1", "d1id1a_", "d1id1a_", "d1oi7a1");
