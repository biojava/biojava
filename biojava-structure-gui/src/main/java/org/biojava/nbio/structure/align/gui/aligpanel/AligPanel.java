...
public class AligPanel  extends JPrintPanel implements AlignmentPositionListener, WindowListener {
   ...
   private AligmentCoordManager coordManager;
   ...
   public AligPanel(){
	      ...
	      coordManager = new AligmentCoordManager();
    ...
    */
   public AligPanel(AFPChain afpChain, Atom[] ca1, Atom[] ca2, Color[] colors) throws StructureAlignmentException, StructureException{
	   this();
   ...
   public AligPanel(AFPChain afpChain, Atom[] ca1, Atom[] ca2) throws StructureAlignmentException, StructureException{
 ...
 * @throws StructureAlignmentException 
    */
   public AligPanel(MultipleAlignment multAln, Color[] colors) throws StructureAlignmentException{
	   this();
   ...
   public AligPanel(MultipleAlignment multAln) throws StructureAlignmentException{
	   this(multAln,DEFAULT_COLORS);
   }
   
   public AligmentCoordManager getCoordManager() {
      return coordManager;
   }
   ...
   public MultipleAlignment getMultipleAlignment(){
	...
	public void paintComponent(Graphics g){
      ...
      int startpos = 0;
      int endpos = multAln.getAlnSequences().size();
      ...
      int nrLines = length / AligmentCoordManager.DEFAULT_LINE_LENGTH;
      ...
      for (int i = 0 ; i < nrLines ; i++){
         ...
         try {
        	...
        	for (int str=0; str<size; str++){
	            ...
	            int aligPos = i * AligmentCoordManager.DEFAULT_LINE_LENGTH;
	            ...
	            aligPos = i * AligmentCoordManager.DEFAULT_LINE_LENGTH + AligmentCoordManager.DEFAULT_LINE_LENGTH -1 ;
